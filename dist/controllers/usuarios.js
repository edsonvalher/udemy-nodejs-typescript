...
exports.deleteUsuarioLogico = exports.deletetUsuario = exports.puttUsuario = exports.posttUsuario = exports.getUsuario = exports.getUsuarios = void 0;
...
const posttUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { body } = req;
    try {
...
const deleteUsuarioLogico = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const usuario = yield usuario_1.default.findByPk(id);
    if (!usuario) {
        return res.status(400).json({
...
exports.deleteUsuarioLogico = deleteUsuarioLogico;
